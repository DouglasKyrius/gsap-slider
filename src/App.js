          ...
          <div className="t-image">
            <ul ref={el => (imageList = el)}>
              <li className={state.isActive1 ? 'active' : ''}>
                <img src={testimonials[0].image} alt={`${testimonials[0].name} Image`} />
              </li>
              <li className={state.isActive2 ? 'active' : ''}>
                <img src={testimonials[1].image} alt={`${testimonials[1].name} Image`} />
              </li>
              <li className={state.isActive3 ? 'active' : ''}>
                <img src={testimonials[2].image} alt={`${testimonials[2].name} Image`} />
              </li>
            </ul>
          </div>
